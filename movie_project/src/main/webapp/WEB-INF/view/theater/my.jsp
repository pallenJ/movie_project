    ...
    <body>
        ...
        <div class="area">
            ...
            <div class="text-right" style="margin-right: 20px;">
                <a href='<c:url value="/theater/edit"/>' class="btn btn-outline-secondary">영화관 수정</a>
                <a href='<c:url value="/theater/delete"/>' class="btn btn-outline-primary">영화관 삭제</a>
            </div>
            <div class="content">
                <div class="card border-info mb-3" style="max-width: 20rem; margin: auto;">
                    <div class="card-header">${theater.name }</div>
                    <div class="card-body" style="text-align: left;">
                        <h6 class="card-title">지역 : </h6><h5 class="card-text">${theater.region}</h5>
